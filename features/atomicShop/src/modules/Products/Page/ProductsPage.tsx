...
import { MOCK_PRODUCT } from '../mock/product.mock';
...
export const ProductsPage = () => {
    ...
    const [filtroEstado, setFiltroEstado] = useState<boolean>(false);
    ...
    const categorias = ['Todas', ...Array.from(new Set(MOCK_PRODUCT.map(p => p.categoria)))];
    const estados = ['Todos', 'Frecuente', 'Común', 'Restringido'];

    // Filtrado
    const productosFiltrados = products?.data.filter(p => {
        ...
        <div className="p-6 md:p-8 space-y-6">
            ...
            >
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">{MOCK_PRODUCT.length} productos registrados</p>
                </div>
                                        ...
                                        productosPagina.map((product, idx) => {
                                            return (
                                                ...
                                                >
                                                    ...
                                                    {/* Marca */}
                                                    <td className="px-4 py-3 text-gray-600">{product.brandId}</td>
