...
export const MUNICIPALITIES = {
  ...
  "Cuscatlán": ["Candelaria", "Cojutepeque", "El Carmen", "El Rosario", "Monte San Juan", "Oratorio de Concepción", "San Bartolomé Perulapía", "San Cristóbal", "San José Guayabal", "San Pedro Perulapán", "Santa Cruz Analquito", "Santa Cruz Michapa", "Suchitoto", "San Ramón"],
  "La Libertad": ["Antiguo Cuscatlán", "Chiltiupán", "Ciudad Arce", "Colón", "Comasagua", "Huizúcar", "Jayaque", "Jicalapa", "La Libertad", "Nuevo Cuscatlán", "Quezaltepeque", "Sacacoyo", "San Juan Opico", "San Pablo Tacachico", "Santa Tecla", "Tamanique", "Talnique", "Teotepeque", "Tepecoyo", "Zaragoza"],
