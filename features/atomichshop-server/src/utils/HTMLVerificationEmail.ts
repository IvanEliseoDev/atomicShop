export const HTMLVerificationEmail = (code: string): string => {
  return `
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f4f4; padding: 20px; border-radius: 10px; max-width: 600px; margin: auto;">
      <div style="background-color: #ffffff; padding: 40px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <h3 style="color: #333; text-align: center;">Verifica tu cuenta</h3>
        <p style="color: #555; font-size: 16px; line-height: 1.5;">
          Gracias por registrarte en AtomicShop. Usa el siguiente código para verificar tu correo electrónico y activar tu cuenta:
        </p>
        ...
        <p style="color: #777; font-size: 14px; text-align: center;">
          Este código expirará en <strong>15 minutos</strong>. Si no creaste una cuenta en AtomicShop, puedes ignorar este correo.
        </p>
